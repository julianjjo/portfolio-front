...
const ExperienceCards = () => {
    const experiences = [
        ...
        { key: 'farmatodo', title: 'Farmatodo', time: 'Currently, 2 years', description: 'Backend developer in <span class="font-bold">Spring Boot</span>, developing new functionalities for microservices, working with <span class="font-bold">OracleDB</span> and <span class="font-bold">PostgreSQL</span>.', logos: [{key: 0, svg: <JavaIcon width="50" height="50"/>}, {key: 1, svg: <SpringBootIcon width="50" height="50"/>}, {key: 2, svg: <OracleIcon width="50" height="50"/>}, {key: 3, svg: <PostgreSqlIcon width="50" height="50"/>}, {key: 4, svg: <GoogleCloudIcon width="50" height="50"/>}]},
    ];
    ...
    return (
        <div className="grid sm:grid-cols-2 md:grid-cols-2 grid-rows-2 gap-4 m-4 mt-20">
            {experiences.map((experience, index) => (
                <div key={index} className="bg-white bg-opacity-80 shadow-md shadow-gray-800 rounded-3xl md:m-9 md:hover:scale-110 md:transition md:duration-300 md:ease-in-out">
